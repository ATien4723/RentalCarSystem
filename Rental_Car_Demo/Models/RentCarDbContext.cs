...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=(local);database=RentCarDB;uid=sa;pwd=mq808103;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdditionalFunction>(entity =>
        {
            entity.HasKey(e => e.FucntionId).HasName("PK__Addition__1A8C7CAF6184948F");
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Address__26A111ADE10EDBE6");
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Addresses)
                ...
                .HasConstraintName("FK__Address__cityId__5812160E");

            entity.HasOne(d => d.District).WithMany(p => p.Addresses)
                .HasForeignKey(d => d.DistrictId)
                .HasConstraintName("FK__Address__distric__59063A47");

            entity.HasOne(d => d.Ward).WithMany(p => p.Addresses)
                .HasForeignKey(d => d.WardId)
                .HasConstraintName("FK__Address__wardId__59FA5E80");
        });

        modelBuilder.Entity<Booking>(entity =>
        {
            entity.HasKey(e => e.BookingNo).HasName("PK__Booking__C6D0626691138142");
            ...
            entity.HasOne(d => d.Driver).WithMany(p => p.Bookings)
                ...
                .HasConstraintName("FK__Booking__driverI__5BE2A6F2");
        ...
        {
            entity.HasKey(e => e.CarId).HasName("PK__Car__1436F174F253CD02");
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.Cars)
                ...
                .HasConstraintName("FK__Car__addressId__5DCAEF64");

            entity.HasOne(d => d.Brand).WithMany(p => p.Cars)
                .HasForeignKey(d => d.BrandId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Car__brandId__5EBF139D");

            entity.HasOne(d => d.Color).WithMany(p => p.Cars)
                .HasForeignKey(d => d.ColorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Car__colorId__5FB337D6");

            entity.HasOne(d => d.Document).WithMany(p => p.Cars)
                .HasForeignKey(d => d.DocumentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Car__documentId__60A75C0F");

            entity.HasOne(d => d.Fucntion).WithMany(p => p.Cars)
                .HasForeignKey(d => d.FucntionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Car__fucntionId__619B8048");
            ...
            entity.HasOne(d => d.Term).WithMany(p => p.Cars)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Car__termId__6383C8BA");
        ...
        {
            entity.HasKey(e => e.DocumentId).HasName("PK__CarDocum__EFAAAD85A7C1348D");
        ...
        {
            entity.HasKey(e => e.DriverId).HasName("PK__Driver__F1532DF252C4C224");

            entity.ToTable("Driver");

            entity.HasIndex(e => e.Email, "UQ__Driver__AB6E616493C4A95D").IsUnique();
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__2613FD24A2C2D0C5");
        ...
        {
            entity.HasKey(e => e.TermId).HasName("PK__TermOfUs__90C2BD1EFFA9A67E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TokenInf__3214EC07DFD41AE1");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__CB9A1CFF730D25F5");

            entity.ToTable("User");

            entity.HasIndex(e => e.Email, "UQ__User__AB6E616405A993ED").IsUnique();
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.Users)
                .HasForeignKey(d => d.AddressId)
                .HasConstraintName("FK__User__addressId__68487DD7");
        });

        modelBuilder.Entity<Wallet>(entity =>
        {
            entity.HasKey(e => e.WalletId).HasName("PK__Wallet__3785C870EECE1F44");
